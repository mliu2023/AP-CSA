/**
* Class to create sea transportation.
* @author Max Liu
* @version 1.0
*/
public class Sea extends WaterSafety{
  /**
  * This method constructs a method transportation involving sea.
  ...
  */
  public Sea(int numOfTicketsSold, double farePerPerson, boolean fireExtinguisher, int numberOfLifeJacket, int numberOfLifeBoat, int capacityOfLifeBoat){
  ...
  */
  ...
  /**
  * This method allows sea transportation to be printed.
